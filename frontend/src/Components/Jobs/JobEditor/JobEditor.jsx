...
import { Container, Typography, Grid, Card, CardHeader, CardContent, CardActions, Paper } from "@mui/material"
...
const JobEditor = (props) => {
    ...
    */
    ...
    const showError = <ErrorMessage message={useError} action={()=> setError(null)} />
           ...
           <Grid container columns={12}>
            <Grid item columns={4}>
                <Paper elevation={16} square>
                    <Card>
                        <CardHeader title={props.job?.Nombre || "Nuevo Trabajo"} subheader={props.job?.Cantidad || ""}/>
                    </Card>
                    <CardContent>
