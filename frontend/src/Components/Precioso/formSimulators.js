    ...
    export const Laminado = ( valor , minimo , cantidad , largoPliego , duplex )=> {
        let resultado = valor * (cantidad * ((largoPliego > 520)?largoPliego/10 * 1.15:largoPliego/10))
        resultado = (resultado < minimo)?minimo:resultado

        
        console.log(`${valor} * (${cantidad} * ((${largoPliego}>520)?${largoPliego} * 1.15)) * ${largoPliego}`)
        console.log(`Resultado: ${resultado}`)
    ...
    export const Nuvera = ( valor , minimo , cantidad , entrada , largoPliego )=> {
        ...
        console.log(`${entrada} + (${cantidad}*((${largoPliego}>355)?1:(1.6))) * ${valor}`)
        console.log(`Resultado: ${resultado}`)
    ...
    export const iGenBN = ( valor , minimo , cantidad , entrada , largoPliego )=> {
        ...
        console.log(`${entrada} + (${cantidad}*((${largoPliego}>488)?1:(1.25))) * ${valor}`)
        console.log(`Resultado: ${resultado}`)
