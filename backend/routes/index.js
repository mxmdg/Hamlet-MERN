...
/*
 * Router maestro. Tabla central de permisos: de un vistazo se ve
 * quién puede hacer qué en cada ruta.
 */
...
router.use(
  ...
  require("../extensions/papyrus/papyrusRouter"),   // <- nuevo
);
...
// SUPERADMIN: vistas globales cross-tenant. Todo protegido como master.
router.use(
  "/Hamlet/master",
  requireRoleByMethod({
    get: "master",
